...
class _AirScreenState extends State<AirScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: Stack(fit: StackFit.expand,
            // wybiera najwiekszy mozliwy rozmiar dla dzieci
            children: <Widget>[
          Container(
                ...
                children: [
                  Padding(
                      padding: EdgeInsets.only(
                          bottom: 14, top: 62, left: 10, right: 10),
                      child: Divider(
                        height: 10,
                        color: getBackgroundTextColor(widget.air),
                        thickness: 1,
                  ...
                  Padding(
                      padding: EdgeInsets.only(bottom: 24, left: 10, right: 10),
                      child: ClipRRect(
        ...
        // ustawienie do dolu (wypozycjonowany w stosunku do czegos)
  ...
  getAdviceImage(AirQuality air) {
    if (air.isGood) {
      ...
      return AssetImage('icons/bad.png');
    }
  }
}
